...
def gengen(generator_source, builddir='./build',
    ...
    halide_paths = get_halide_paths(lib_ext='.lib')
    ...
    try:
        ...
        # Compile
        cmd = 'cl {0} -D_HAS_EXCEPTIONS=0 /GR- /MD /Z7 /O2 {1} {2} {3} {4} /Fe"{5}" /link /OPT:REF'.format(
        ...
        cmd = ('cl.exe -D_HAS_EXCEPTIONS=0 /GR- /LD /MD /Z7 /O2 {0} {1} {2} '
